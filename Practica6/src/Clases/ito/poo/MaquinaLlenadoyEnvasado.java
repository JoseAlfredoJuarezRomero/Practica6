...
public String toString() {
	return "MaquinaLlenadoyEnvasado [cantiEnvasesLlenadosMin=" + cantiEnvasesLlenadosMin
			+ ", listaRegulacionMililitros=" + listaRegulacionMililitros + ", costoLlenadoyEnvasado="
			+ costoLlenadoyEnvasado + ", costoBotella=" + costoBotella + "]";
}
